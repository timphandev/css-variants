...
- [vs class-variance-authority](https://github.com/timphandev/css-variants/blob/main/benchmark/cva.bench.ts)
- [vs tailwind-variants](https://github.com/timphandev/css-variants/blob/main/benchmark/tailwind-variants.bench.ts)
