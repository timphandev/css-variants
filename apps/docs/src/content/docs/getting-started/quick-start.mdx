---
title: Quick Start Guide — Build Your First CSS Variant
description: Learn how to create type-safe CSS variants in 5 minutes. Step-by-step tutorial with React, Vue, and Solid.js examples.
---
